...
<![endif]-->
	...
	<script src="<%=request.getContextPath()%>/assets/js/plupload/plupload.full.min.js"></script>
	<script src="<%=request.getContextPath()%>/assets/js/jquery.min.js"></script>
	<script src="<%=request.getContextPath()%>/assets/js/amazeui.js"></script>
	<script src="<%=request.getContextPath()%>/assets/js/upload/qiniu.min.js"></script>
