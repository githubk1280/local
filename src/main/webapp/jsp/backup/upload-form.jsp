...
<!-- 	</nav> -->
<!-- 	<fieldset> -->
<!-- 		<form class="am-form" action="/local/event/addForm" method="post" enctype="multipart/form-data"> -->
<!-- 			<div id="container"> -->
...
<!-- 			<br /> -->
<!-- 			<div class="am-form-group"> -->
<!-- 				<label for="doc-ipt-file-1">传个图片  (<i class="am-icon-camera-retro"></i>可以拍照上传哦)</label> <input type="file" -->
